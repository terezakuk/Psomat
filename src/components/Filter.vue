<template>
  <div class="vyhledavac">
    ...
    <div class="viewbox">
      ...
      <div class="group">
        <div class="selektor" v-on:click="zkusenosti=!zkusenosti"> 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (zkusenosti ? 'group-open' : 'group-closed')">
      ...
      <div class="group">
        <div class="selektor" v-on:click="bytZahrada=!bytZahrada">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (bytZahrada ? 'group-open' : 'group-closed')">
           <path d="M7 13.1l8.9 8.9c.8-.8.8-2 0-2.8l-6.1-6.1 6-6.1c.8-.8.8-2 0-2.8L7 13.1z"/>
          </svg>
          Do bytu / na zahradu
        </div> 
      ...
      <div class="group">
        <div class="selektor" v-on:click="vztahZvirata=!vztahZvirata">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (vztahZvirata ? 'group-open' : 'group-closed')">
           <path d="M7 13.1l8.9 8.9c.8-.8.8-2 0-2.8l-6.1-6.1 6-6.1c.8-.8.8-2 0-2.8L7 13.1z"/>
          </svg>
          Vztah psa ke zvířatům
        </div>
        <div v-if="vztahZvirata">
          <div class="text"> 
      ...
      <div class="group">
        <div class="selektor" v-on:click="dleHmotnosti=!dleHmotnosti">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (dleHmotnosti ? 'group-open' : 'group-closed')">
           <path d="M7 13.1l8.9 8.9c.8-.8.8-2 0-2.8l-6.1-6.1 6-6.1c.8-.8.8-2 0-2.8L7 13.1z"/>
          </svg>
          Podle hmotnosti
          </div>
          <div v-if="dleHmotnosti">
          <div class="text">
      ...
      <div class="group">
        <div class="selektor" v-on:click="dleVysky=!dleVysky">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (dleVysky ? 'group-open' : 'group-closed')">
           <path d="M7 13.1l8.9 8.9c.8-.8.8-2 0-2.8l-6.1-6.1 6-6.1c.8-.8.8-2 0-2.8L7 13.1z"/>
          </svg>
          Podle výšky
          </div>
      ...
      <div class="group">
        <div class="selektor" v-on:click="dlePlemene=!dlePlemene">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" :class="'icon-previous ' + (dlePlemene ? 'group-open' : 'group-closed')">
           <path d="M7 13.1l8.9 8.9c.8-.8.8-2 0-2.8l-6.1-6.1 6-6.1c.8-.8.8-2 0-2.8L7 13.1z"/>
          </svg>
          Podle plemene
          </div>
